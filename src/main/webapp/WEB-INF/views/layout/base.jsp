        ...
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <div class="footer-box get-in-touch">
                    ...
                    <ul>
                        <li>No.2/56,Puttalam Road,Nikaweratiya.</li>
                        <li>zuki@gmail.com</li>
                        <li>0771225494</li>
                        <li>0771388771</li>
                    </ul>
                </div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="footer-box about-widget">
                    ...
                    <p>Here we are the zuki.com™ to plan your delicious dinner with us..</p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-12">
                <p>Copyrights &copy; 2023 - zuki.com - All Rights Reserved.<br>
                </p>
            </div>
...
<script>
    ...
    document.querySelector('.btn-MyAccount').addEventListener('click',(evt) => {
