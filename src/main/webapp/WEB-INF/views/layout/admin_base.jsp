...
<head>
    ...
    <title>${App.getString('app_name')} - Admin</title>
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="${admin_assets}/vendor/bootstrap/css/bootstrap.min.css">
    <link href="${admin_assets}/vendor/fonts/circular-std/style.css" rel="stylesheet">
...
<div class="dashboard-main-wrapper">
    ...
    <div class="dashboard-header">
        <nav class="navbar navbar-expand-lg bg-white fixed-top">
            <a class="navbar-brand" style="color: orangered" href="${BASE_URL}">${App.getString('app_name')} - ADMIN</a>
...
<%--                                                <div class="notification-list-user-img"><img src="${admin_assets}/images/avatar-2.jpg" alt="" class="user-avatar-md rounded-circle"></div>--%>
...
<%--                                            <div class="notification-info">--%>
<%--                                                <div class="notification-list-user-img"><img src="${admin_assets}/images/avatar-3.jpg" alt="" class="user-avatar-md rounded-circle"></div>--%>
...
<%--                                        <a href="#" class="list-group-item list-group-item-action">--%>
<%--                                            <div class="notification-info">--%>
<%--                                                <div class="notification-list-user-img"><img src="${admin_assets}/images/avatar-4.jpg" alt="" class="user-avatar-md rounded-circle"></div>--%>
...
<%--                                        <a href="#" class="list-group-item list-group-item-action">--%>
<%--                                            <div class="notification-info">--%>
<%--                                                <div class="notification-list-user-img"><img src="${admin_assets}/images/avatar-5.jpg" alt="" class="user-avatar-md rounded-circle"></div>--%>
...
<%--                                        <a href="#" class="connection-item"><img src="${admin_assets}/images/github.png" alt="" > <span>Github</span></a>--%>
<%--                                    </div>--%>
<%--                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 ">--%>
<%--                                        <a href="#" class="connection-item"><img src="${admin_assets}/images/dribbble.png" alt="" > <span>Dribbble</span></a>--%>
<%--                                    </div>--%>
<%--                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 ">--%>
<%--                                        <a href="#" class="connection-item"><img src="${admin_assets}/images/dropbox.png" alt="" > <span>Dropbox</span></a>--%>
<%--                                    </div>--%>
<%--                                </div>--%>
<%--                                <div class="row">--%>
<%--                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 ">--%>
<%--                                        <a href="#" class="connection-item"><img src="${admin_assets}/images/bitbucket.png" alt=""> <span>Bitbucket</span></a>--%>
<%--                                    </div>--%>
<%--                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 ">--%>
<%--                                        <a href="#" class="connection-item"><img src="${admin_assets}/images/mail_chimp.png" alt="" ><span>Mail chimp</span></a>--%>
<%--                                    </div>--%>
<%--                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 ">--%>
<%--                                        <a href="#" class="connection-item"><img src="${admin_assets}/images/slack.png" alt="" > <span>Slack</span></a>--%>
<%--                                    </div>--%>
<%--                                </div>--%>
                            </li>
                            <li>
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav flex-column">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link" href="${BASE_URL}admin" ><i class="fa fa-fw fa-user-circle"></i>Dashboard <span class="badge badge-success">6</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-2" aria-controls="submenu-2"><i class="fa fa-fw fa-rocket"></i>Foods</a>
                            <div id="submenu-2" class="collapse submenu" style="">
                                <ul class="nav flex-column">
                                    <li class="nav-item">
                                        <a class="nav-link" href="${BASE_URL}admin/product">View All</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="${BASE_URL}admin/product/add">Add New</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="${BASE_URL}admin/category" ><i class="fa fa-fw fa-user-circle"></i>Category <span class="badge badge-success">6</span></a>
                        </li>
                        <li class="nav-item ">
                            <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-4" aria-controls="submenu-4"><i class="fab fa-fw fa-wpforms"></i>Customer</a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-5" aria-controls="submenu-5"><i class="fas fa-fw fa-table"></i>History</a>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            Copyright © 2023 ${App.getString('app_name')}. All rights reserved. Dashboard by <a href="${BASE_URL}">${App.getString('app_name')}</a>.
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
