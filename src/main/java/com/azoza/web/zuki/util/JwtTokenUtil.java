package com.azoza.web.zuki.util;
...
public class JwtTokenUtil {
    ...
    private static final String SECRET = "x1AZqY4z}5yHF*N}CMZ?+.]-7;R#zYG2CF,/d9Fv(}mfv[Ka(F7Td{K]w%X8g9K]";
    ...
    public String generateAccessToken(User user) {
        ...
        return generateToken(claims, TOKEN_LIFE, user.getPassword());
