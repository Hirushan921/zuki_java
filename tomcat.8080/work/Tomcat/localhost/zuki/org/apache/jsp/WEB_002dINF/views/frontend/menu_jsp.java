 ...
 * Generated at: 2023-10-24 03:52:23 UTC
...
public final class menu_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  private boolean _jspx_meth_layout_005fextends_005f0(jakarta.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/frontend/menu.jsp(4,0) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_layout_005fput_005f0(jakarta.servlet.jsp.tagext.JspTag _jspx_parent, jakarta.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/frontend/menu.jsp(5,4) name = block type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_layout_005fput_005f0.setBlock("content");
      // /WEB-INF/views/frontend/menu.jsp(5,4) name = type type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_layout_005fput_005f1(jakarta.servlet.jsp.tagext.JspTag _jspx_parent, jakarta.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/frontend/menu.jsp(124,4) name = block type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_layout_005fput_005f1.setBlock("script");
      // /WEB-INF/views/frontend/menu.jsp(124,4) name = type type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      extends org.apache.jasper.runtime.JspFragmentHelper
  {
      ...
      throws java.lang.Throwable
    {
      ...
      out.write("                            <p id=\"a1\">Healthy and Delicious</p>\r\n");
      ...
      out.write("                </div>\r\n");
      out.write("\r\n");
      out.write("                <div class=\"row \" id=\"productContainr\">\r\n");
      out.write('\r');
      out.write('\n');
      out.write('\r');
      out.write('\n');
      ...
      throws java.lang.Throwable
    {
      ...
      out.write("                    .then(data => {\r\n");
      out.write("                        // Get the product container\r\n");
      out.write("                        const productContainer = document.getElementById('productContainr');\r\n");
      out.write("\r\n");
      out.write("                        // Loop through each product in the data\r\n");
      out.write("                        data.forEach(product => {\r\n");
      out.write("                            // Create elements for the product card\r\n");
      out.write("                            const productCard = document.createElement('div');\r\n");
      out.write("                            fetch(`");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${BASE_URL}", java.lang.String.class, (jakarta.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("admin/api/v1/category/`+ product.cid)\r\n");
      out.write("                                .then(categoryResponse => categoryResponse.json())\r\n");
      out.write("                                .then(categoryData => {\r\n");
      out.write("                                  let cname = categoryData.name;\r\n");
      out.write("                                    productCard.className = 'col-lg-4 col-md-6 text-center ' + cname;\r\n");
      out.write("                                });\r\n");
      out.write("\r\n");
      out.write("                            const productItem = document.createElement('div');\r\n");
      out.write("                            productItem.className = 'single-product-item';\r\n");
      out.write("\r\n");
      out.write("                            const productImage = document.createElement('div');\r\n");
      out.write("                            productImage.className = 'product-image';\r\n");
      out.write("\r\n");
      out.write("                            const imageLink = document.createElement('a');\r\n");
      out.write("                            imageLink.href = 'single-product.html';\r\n");
      out.write("\r\n");
      out.write("                            let imgElement = document.createElement(\"img\");\r\n");
      out.write("                            imgElement.src = \"http://localhost:8080/zuki\" + product.images;\r\n");
      out.write("                            imgElement.alt = \"Product Image\";\r\n");
      out.write("                            imgElement.style.width = \"250px\";\r\n");
      out.write("                            imgElement.style.height = \"180px\"\r\n");
      out.write("\r\n");
      out.write("                            imageLink.appendChild(imgElement);\r\n");
      out.write("                            productImage.appendChild(imageLink);\r\n");
      out.write("\r\n");
      out.write("                            const productName = document.createElement('h3');\r\n");
      out.write("                            productName.textContent = product.name;\r\n");
      out.write("\r\n");
      out.write("                            const productDescription = document.createElement('span');\r\n");
      out.write("                            productDescription.innerHTML = product.description;\r\n");
      out.write("\r\n");
      out.write("                            const productPrice = document.createElement('p');\r\n");
      out.write("                            productPrice.className = 'product-price';\r\n");
      out.write("                            let pprice = \"Rs. \"+ product.price +\".00\";\r\n");
      out.write("                            productPrice.innerHTML = pprice;\r\n");
      out.write("\r\n");
      out.write("                            const cartBtn = document.createElement('a');\r\n");
      out.write("                            cartBtn.href = 'cart.html';\r\n");
      out.write("                            cartBtn.className = 'cart-btn';\r\n");
      out.write("                            cartBtn.innerHTML = '<i class=\"fas fa-shopping-cart\"></i> Add to Cart';\r\n");
      out.write("\r\n");
      out.write("                            // Append elements to the product card\r\n");
      out.write("                            productItem.appendChild(productImage);\r\n");
      out.write("                            productItem.appendChild(productName);\r\n");
      out.write("                            productItem.appendChild(productDescription);\r\n");
      out.write("                            productItem.appendChild(productPrice);\r\n");
      out.write("                            productItem.appendChild(cartBtn);\r\n");
      out.write("\r\n");
      out.write("                            productCard.appendChild(productItem);\r\n");
      out.write("\r\n");
      out.write("                            // Append the product card to the container\r\n");
      out.write("                            productContainer.appendChild(productCard);\r\n");
      out.write("                        });\r\n");
      out.write("                    })\r\n");
      ...
      out.write("                    .then(response => response.json())\r\n");
      out.write("                    .then(data => {\r\n");
      out.write("                        let pcat = document.getElementById('pcat');\r\n");
      out.write("                        data.forEach(category => {\r\n");
      out.write("                            let li = document.createElement('li');\r\n");
      out.write("                            li.innerHTML = category.name;\r\n");
      out.write("                            pcat.appendChild(li);\r\n");
      out.write("                        });\r\n");
      out.write("\r\n");
      out.write("                    });\r\n");
      out.write("            }\r\n");
      ...
      out.write("\r\n");
      out.write("            // Call the function to load products when the page loads\r\n");
      out.write("            window.onload = loadProducts;\r\n");
      out.write("        </script>\r\n");
      out.write("    ");
      return false;
    }
