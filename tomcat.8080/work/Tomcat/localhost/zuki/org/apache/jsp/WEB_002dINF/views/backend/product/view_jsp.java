 ...
 * Generated at: 2023-10-19 17:59:01 UTC
...
public final class view_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  private boolean _jspx_meth_layout_005fextends_005f0(jakarta.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/backend/product/view.jsp(2,0) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_layout_005fput_005f0(jakarta.servlet.jsp.tagext.JspTag _jspx_parent, jakarta.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/backend/product/view.jsp(3,2) name = block type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_layout_005fput_005f1(jakarta.servlet.jsp.tagext.JspTag _jspx_parent, jakarta.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/backend/product/view.jsp(64,2) name = block type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_layout_005fput_005f1.setBlock("script");
      // /WEB-INF/views/backend/product/view.jsp(64,2) name = type type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      extends org.apache.jasper.runtime.JspFragmentHelper
  {
      ...
      throws java.lang.Throwable
    {
      ...
      out.write("          <h2 class=\"pageheader-title\">Foods </h2>\r\n");
      ...
      out.write("                <li class=\"breadcrumb-item active\" aria-current=\"page\">View All</li>\r\n");
      out.write("              </ol>\r\n");
      out.write("            </nav>\r\n");
      out.write("          </div>\r\n");
      out.write("        </div>\r\n");
      ...
      out.write("          <div class=\"card-header container-fluid\">\r\n");
      out.write("            <div class=\"d-flex bd-highlight\">\r\n");
      out.write("              <div class=\"flex-grow-1 bd-highlight\"><h5 class=\"mb-0\">All Foods</h5></div>\r\n");
      out.write("              <div class=\"bd-highlight\"><a href=\"");
      ...
      out.write("                                           class=\"btn btn-sm btn-primary\">Add New</a></div>\r\n");
      out.write("            </div>\r\n");
      out.write("          </div>\r\n");
      out.write("          <div class=\"card-body\">\r\n");
      out.write("            <div class=\"table-responsive\">\r\n");
      out.write("              <table id=\"table-products\" class=\"table table-striped table-bordered second\"\r\n");
      ...
      out.write("                  <th>Food Price(Rs.)</th>\r\n");
      out.write("                  <th>Delivery Charge(Rs.)</th>\r\n");
      ...
      throws java.lang.Throwable
    {
      ...
      out.write("                .then(data => {\r\n");
      out.write("                  let table = document.querySelector('#table-products tbody');\r\n");
      out.write("                  table.innerHTML = \"\";\r\n");
      out.write("                  //document.querySelector('#table-products tbody').innerHTML = \"\";\r\n");
      out.write("                  data.forEach(async product => {\r\n");
      ...
      out.write("                              let cell = row.insertCell();\r\n");
      out.write("                              cell.innerHTML =categoryData.name;\r\n");
      out.write("                            });\r\n");
      out.write("\r\n");
      ...
      out.write("                    imgElement.style.width = \"100px\";\r\n");
      out.write("                    imgElement.style.height = \"70px\"\r\n");
      out.write("                    cell.appendChild(imgElement);\r\n");
      out.write("\r\n");
      out.write("                    cell = row.insertCell();\r\n");
      out.write("                    cell.innerHTML = product.name;\r\n");
      out.write("                    cell = row.insertCell();\r\n");
      out.write("                    cell.innerHTML = product.price+\".00\";\r\n");
      out.write("                    cell = row.insertCell();\r\n");
      out.write("                    cell.innerHTML = product.discountPrice+\".00\";\r\n");
      out.write("                    cell = row.insertCell();\r\n");
      out.write("                    cell.innerHTML = product.quantity;\r\n");
      out.write("                    cell = row.insertCell();\r\n");
      out.write("                    cell.innerHTML = product.description;\r\n");
      out.write("                    cell = row.insertCell();\r\n");
      out.write("                    cell.innerHTML = product.createdAt;\r\n");
      out.write("                    cell = row.insertCell();\r\n");
      out.write("                    cell.innerHTML = '<a class=\"mr-2 text-primary\" href=\"\" >Edit</a>' +\r\n");
      out.write("                            '<a class=\"text-danger\" href=\"javascript:;\" onclick=\"deleteProduct(' + product.id + ')\">Delete</a>'\r\n");
      out.write("                  });\r\n");
      out.write("\r\n");
      out.write("                });\r\n");
      out.write("      }\r\n");
      ...
      out.write("        fetch('");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${BASE_URL}", java.lang.String.class, (jakarta.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("admin/api/v1/product/'+id,{\r\n");
