 ...
 * Generated at: 2023-10-19 17:06:18 UTC
...
public final class category_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  private boolean _jspx_meth_layout_005fextends_005f0(jakarta.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/backend/product/category.jsp(3,0) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_layout_005fput_005f0(jakarta.servlet.jsp.tagext.JspTag _jspx_parent, jakarta.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/backend/product/category.jsp(5,4) name = block type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_layout_005fput_005f1(jakarta.servlet.jsp.tagext.JspTag _jspx_parent, jakarta.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/backend/product/category.jsp(75,4) name = block type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      extends org.apache.jasper.runtime.JspFragmentHelper
  {
      ...
      throws java.lang.Throwable
    {
      ...
      out.write("                    <h2 class=\"pageheader-title\">Category</h2>\r\n");
      ...
      out.write("                        <h3 class=\"section-title\">Add New Category</h3>\r\n");
      out.write("                        <p></p>\r\n");
      out.write("                    </div>\r\n");
      out.write("                    <div class=\"card\">\r\n");
      out.write("                        <h5 class=\"card-header\">Category</h5>\r\n");
      out.write("                        <div class=\"card-body\">\r\n");
      out.write("                            <div class=\"form-group\">\r\n");
      out.write("                                <div class=\"row\">\r\n");
      out.write("                                <label for=\"cat-name\" class=\"col-form-label col-sm-12\">Category Name</label>\r\n");
      out.write("                                <input id=\"cat-name\" type=\"text\" class=\"form-control col-sm-5 ml-3\">\r\n");
      out.write("                                <p class=\"text-right col-sm-6\">\r\n");
      out.write("                                    <button id=\"add-category\" class=\"btn btn-space btn-primary\">Save</button>\r\n");
      ...
      out.write("                                <table id=\"table-category\" class=\"table table-striped table-bordered second\"\r\n");
      ...
      throws java.lang.Throwable
    {
      ...
      out.write("        <script>\r\n");
      out.write("\r\n");
      out.write("            document.querySelector('#add-category').addEventListener('click', (evt) => {\r\n");
      out.write("                evt.preventDefault();\r\n");
      out.write("                let categoryName = document.querySelector('#cat-name').value;\r\n");
      out.write("\r\n");
      out.write("                fetch('");
      ...
      out.write("                        ");
      out.write("\r\n");
      out.write("                        let qtyfield = document.getElementById('cat-name');\r\n");
      out.write("                        qtyfield.value='';\r\n");
      out.write("                        loadCategory();\r\n");
      out.write("                    })\r\n");
      out.write("            });\r\n");
      out.write("\r\n");
      out.write("            function loadCategory() {\r\n");
      out.write("                fetch('");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${BASE_URL}", java.lang.String.class, (jakarta.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("admin/api/v1/category')\r\n");
      out.write("                    .then(response => response.json())\r\n");
      out.write("                    .then(data => {\r\n");
      out.write("                        let table = document.querySelector('#table-category tbody');\r\n");
      ...
      out.write("                            cell.innerHTML = category.name;\r\n");
      out.write("                            cell = row.insertCell();\r\n");
      out.write("                            cell.innerHTML = category.createdAt;\r\n");
      out.write("                            cell = row.insertCell();\r\n");
      out.write("                            cell.innerHTML = '<a class=\"mr-2 text-primary\" href=\"\">Edit</a>' +\r\n");
      out.write("                                '<a class=\"text-danger\" href=\"javascript:;\" onclick=\"deleteCategory(' + category.id + ')\">Delete</a>'\r\n");
      out.write("                        });\r\n");
      out.write("\r\n");
      out.write("                    });\r\n");
      out.write("            }\r\n");
      ...
      out.write("                fetch('");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${BASE_URL}", java.lang.String.class, (jakarta.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("admin/api/v1/category/'+id,{\r\n");
